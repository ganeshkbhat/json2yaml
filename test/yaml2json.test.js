...
function runTests() {
    ...
    console.log("====================================================");
    console.log("      Testing fromYAML (YAML -> JSON)    ");
    console.log("====================================================");
...
`;
    ...
    assertDeepEquals(fromYAML(yaml1), expected1, "Test 1: Basic structure, comments, and data types");
...
`;
    ...
    assertDeepEquals(fromYAML(yaml2), expected2, "Test 2: Inline arrays, Nested Objects, and Correct Block Array handling");
...
`;
    ...
    assertDeepEquals(fromYAML(customerYaml), expectedCustomerJson, "Test 3: Customer's provided YAML sample (Version string fixed)");
...
`;
    ...
    const jsonFromYaml = fromYAML(yamlFromJson);
